...
var AB = Number(prompt("Veuillez saisir la longeur du segment AB :"));
var BC = Number(prompt("Veuillez saisir la longeur du segment BC :"));
var CA = Number(prompt("Veuillez saisir la longeur du segment CA :"));
