...
affichage+=`Pour <b>${taille}cm</b> et <b>${poids}kg</b> : <br> <ul>`;
...
switch (true) {
    case (taille >= 145 && taille < 172 && poids >= 43 && poids <= 47 ||
        ...
        affichage +=`<li>Prennez la <b>taille 1</b>.</li>`;
        break;
    case (taille >= 169 && taille < 183 && poids >= 48 && poids <= 53 ||
        ...
        affichage +=`<li>Prennez la <b>taille 2</b>.</li>`;
        break;
    case (taille >= 178 && taille <= 183 && poids >= 54 && poids <= 59 ||
        ...
        affichage +=`<li>Prennez la <b>taille 3</b>.</li>`;
        break;
    default: affichage +=`<li><b>Aucune taille ne vous correspond.</b></li>`;break;
}
