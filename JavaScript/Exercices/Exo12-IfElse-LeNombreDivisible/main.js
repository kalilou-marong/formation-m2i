...
var nb1 = Number(prompt("Veuillez saisir un chiffre/nombre :"));
var nb2 = Number(prompt("Veuillez saisir un chiffre/nombre :"));
...
// // Sugar Syntaxe
// resultat += nb1%nb2===0? 
// `<br>Le nombre <b>${nb1}</b> est divisible par <b>${nb2}</b>`
// :
// `<br>Le nombre <b>${nb1}</b> n'est pas divisible par <b>${nb2}</b>`
